...
interface LooksStarTableProps {
  className?: string
}

export default function LooksStarTable({ className = "" }: LooksStarTableProps) {
  return (
      ...
      <div className="mb-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
          <table className="w-full border-collapse">
            <thead>
              <tr style={{ backgroundColor: "rgba(249, 87, 0, 0.05)" }}>
                <th
                  className="border border-gray-200 px-3 py-2 text-center font-bold text-sm"
                  style={{ color: "#F95700" }}
                >
                  윤기
                </th>
